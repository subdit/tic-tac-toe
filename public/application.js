...
var addBoardToScreen = function addBoardToScreen(arrayOfBoard) {
...
$(function () {
  ...
  $('#new-game').on('click', function (event) {
    ...
    }).then(newGameSuccess).catch(newGameFailure);
  });
});
...
module.exports = {
  addHandlers: addHandlers // same as addHandlers: addHandlers
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var updateMove = function updateMove(data) {};
